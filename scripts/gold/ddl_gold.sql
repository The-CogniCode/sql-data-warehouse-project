...
SELECT
	...
	CASE WHEN ci.cst_gndr != 'n/a' THEN ci.cst_gndr -- tomamos los datos de CRM como los verdaderos
...
SELECT 
	ROW_NUMBER() OVER (ORDER BY pn.prd_end_dt, pn.prd_key) AS product_key, -- Asigna una llave primaria numérica
